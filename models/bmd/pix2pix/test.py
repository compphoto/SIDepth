...
from dependencies.bmd.pix2pix.util import html
from dependencies.bmd.pix2pix.util.guidedfilter import GuidedFilter
from dependencies.bmd.pix2pix.util.visualizer import save_images
...
def test_model():
    ...
    for i, data in enumerate(dataset):
        ...
        save_dirname = os.path.join(
            'results', 'mahdi_pix2pix_unet_l1_basic', 'test_latest')
