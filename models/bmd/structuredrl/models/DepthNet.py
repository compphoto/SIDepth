...
from models.Ours.bmd.structuredrl.models import resnet
from models.Ours.bmd.structuredrl.models.networks import *

# from dependencies.bmd.structuredrl.models.syncbn.modules import nn as NN
...
class Decoder(nn.Module):
    def __init__(self, inchannels=[256, 512, 1024, 2048], midchannels=[256, 256, 256, 512], upfactors=[2, 2, 2, 2], outchannels=1):
        ...
        self.outconv = AO(
            inchannels=self.inchannels[0], outchannels=self.outchannels, upfactor=2)
    ...
    def _init_params(self):
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                ...
                if m.bias is not None:
                    init.constant_(m.bias, 0)
            elif isinstance(m, nn.SyncBatchNorm):  # nn.SyncBatchNorm
...
class DepthNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.decoder = Decoder(inchannels=self.inchannels, midchannels=self.midchannels,
                               upfactors=self.upfactors, outchannels=self.outchannels)
